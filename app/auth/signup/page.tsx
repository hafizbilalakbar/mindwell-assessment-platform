    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Welcome to MindWell. You can now start your assessment.",
        })
        router.push("/")
      } else {
        toast({
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-purple-900 dark:to-indigo-900 flex items-center justify-center p-4">
      ...
      >
        ...
        <Card className="card-professional shadow-2xl">
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <p className="text-center text-sm text-gray-600 dark:text-gray-300">
              ...
              <Link href="/auth/login" className="text-purple-600 hover:text-purple-700 font-medium underline">
                Sign in here
              </Link>
            </p>
          </CardFooter>
        ...
        >
          ...
          <p>By signing up, you agree to receive assessment reminders and wellness tips.</p>
        </motion.div>
      </motion.div>
    </div>
  )
