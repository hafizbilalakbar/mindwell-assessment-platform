      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 group">
            ...
            <span className="text-2xl font-bold text-gradient">MindWell</span>
          </Link>
        </div>

        <Card className="card-professional shadow-2xl">
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Submit Button */}
              <Button type="submit" disabled={isLoading} className="btn-professional w-full h-12">
                {isLoading ? (
                  <>
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <Button
              ...
              className="w-full h-12 border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
            >
              {isGoogleLoading ? (
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
              ) : (
            ...
            <p className="text-center text-sm text-gray-600 dark:text-gray-300">
              ...
              <Link href="/auth/signup" className="text-purple-600 hover:text-purple-700 font-medium underline">
                Create one here
              </Link>
            </p>
          </CardFooter>
        ...
        >
          ...
          <p>We never share your personal information or assessment results.</p>
        </motion.div>
      </motion.div>
    </div>
  )
